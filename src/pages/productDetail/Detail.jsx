      ...
      <div className="w-[50%]">
        ...
        <div className="flex items-center gap-[18px] mt-8">
          ...
          <button
            ...
            className="w-[215px] h-[64px] shadow-md py-4 px-4 sm:px-6 md:px-8 lg:px-10 rounded-[15px] truncate text-[18px] cursor-pointer active:shadow"
          >
          ...
          <button
            ...
            className="w-[215px] h-[64px] shadow-md py-4 px-10 rounded-[15px] truncate text-[18px] cursor-pointer active:shadow"
          >
